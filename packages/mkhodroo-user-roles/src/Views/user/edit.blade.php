        ...
        <div class="col-sm-12 m-1">
            @if ($user->disabled === 1)
                <form method="POST" action="enable" id="enable-form">
                    ...
                    <button onclick="enable()" class="btn btn-primary">فعال سازی کاربر</button>
                </form>
            @else
                <form method="POST" action="disable" id="disable-form">
                    ...
                    @csrf
                    <input type="hidden" value="{{ $user->id }}" name="id">
                    <button onclick="disable()" class="btn btn-danger">غیر فعال سازی کاربر</button>
                </form>
            @endif
        </div>
        <div class="col-sm-6">
