...
<head>
    ...
    <link rel="shortcut icon" href="{{url('public/webphone/favicon.ico')}}"/>
    <title>Softphone</title>

    <link rel="stylesheet" href="{{url('public/webphone/css/softphone/index.css')}}" />
<!-- Themes -->
    <link rel="stylesheet" href="{{url('public/webphone/css/softphone/themes/wphone_1.0.css')}}" /><!-- instead of: <link rel="stylesheet" href="{{url('public/webphone/css/jquery.mobile-1.4.2.min.css')}}" />-->
    <link rel="stylesheet" href="{{url('public/webphone/css/softphone/themes/jquery.mobile.icons.min.css')}}" />
    <link rel="stylesheet" href="{{url('public/webphone/css/softphone/jquery.mobile.structure-1.4.2.css')}}" />
    <link rel="stylesheet" href="{{url('public/webphone/css/softphone/mainlayout.css')}}" />
    ...
    <div role="main" class="ui-content" id="page_message_content" data-theme="b" data-content-theme="b">
        ...
        <div id="msg_textarea_container">
            ...
            <div id="msg_textarea_left">
                ...
                <!--margin="0" padding="0" border="0px" outline="none" cursor="pointer  cursor: pointer;"-->
                <div contenteditable="true" id="msg_textarea" class="noshadow" data-theme="a" style="margin:0; padding:0; border:0px; outline: none;" placeholder="Compose"></div>
                <!--<div contenteditable="true" id="msg_textarea" class="noshadow" data-theme="a"</div>-->
            </div>
