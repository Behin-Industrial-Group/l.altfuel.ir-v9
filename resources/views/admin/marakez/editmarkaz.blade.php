    ...
    <div class="row">
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-sm-12">
                    {{-- <div class="">
                        <a href="<?php echo Url("admin/search-issue/all/NationalID/$markaz->NationalID") ?>">
                            <button class="btn btn-danger">
                                مشاهده تیکت های ثبت شده مرکز
                            </button>
                        </a>
                    </div> --}}
                </div>
                ...
                <form class="form-horizontal" method="POST" action="{{url("admin/marakez/edit/$markaz->id")}}">
                    @csrf
                    <input type="hidden" class="form-control" id="" name="id" value="<?php echo $markaz->id ?>">
                    ...
                    <div class="box-body col-md-6"  style="border:solid 1px">
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" class="form-control price" id="" name="debt" value="<?php echo $markaz->debt ?>">
                                    <p class="cama-seprator" style="font-size:10px"></p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" class="form-control" id="" name="debt_description" value="<?php echo $markaz->debt_description ?>">
                                    <p class="cama-seprator" style="font-size:10px"></p>
                                </td>
                            </tr>
                            <tr>
