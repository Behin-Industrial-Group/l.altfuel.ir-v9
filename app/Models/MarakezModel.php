...
class MarakezModel extends Model
{
    ...
    protected $fillable = [
        'enable', 'ReceivingCodeYear', 'NationalID', 'Name', 'Province', 'City', 'CodeEtehadie', 'GuildNumber', 'IssueDate', 'ExpDate',
        'PostalCode', 'Cellphone', 'Tel', 'Address', 'MembershipFee96', 'MembershipFee97', 'MembershipFee98',
        'MembershipFee99', 'MembershipFee00', 'debt', 'debt_RefID', 'debt_description',
